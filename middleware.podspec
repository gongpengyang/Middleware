...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/gongpengyang/middleware"
  ...
  s.source       = { :git => "https://github.com/gongpengyang/middleware.git", :tag => s.version.to_s }
  ...
  s.source_files  = "middleware/middleware/**/*.{h,m,swift}"
